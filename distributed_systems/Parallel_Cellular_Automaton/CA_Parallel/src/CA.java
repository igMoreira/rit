...
public class CA extends Task{
	...
	/**
	 * Main method used by the pj2 class
	 */
	...
	/**
	 * Specifies a critical section to be used by the parallel threads
	 */
	private static synchronized void calculateStep()
	{
		step++;
		state = pca.calcNextState(state);
	}
	...
	/**
	 * Used to verify what is the current step
	 * @return
	 */
	...
	/**
	 * Display the application output
	 */
	...
	/**
	 * Validates the update rule inputed by the user
	 * @param inputedRule: A String holding the update rule bits
	 * @return: The update rule converted to byte array
	 */
	...
	/**
	 * Valides the number of cells inputed by the user
	 * @param numberOfElements: A string holding the number of cells
	 * @return: The number of cells converted to int
	 */
