...
/**
 * Provides a pub dice application
 * to be played in network
 * @author igMoreira
 *
 */
public class PubDice {
	...
	/**
	 * MAIN method
	 * @param args: Parameters provided by the user
	 */
	public static void main(String[] args) {
		...
		requestController.startMatch(playerName);
	}
	
	/**
	 * Verifies the application call syntax
