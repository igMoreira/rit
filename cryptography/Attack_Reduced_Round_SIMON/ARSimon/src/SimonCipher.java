...
public class SimonCipher {
	...
	/**
	 * Makes the rotate part of a SIMON round
	 * ((rotate left 1) & (rotate left 8)) ^ (rotate left 2)
	 * 
	 * @param text: Text to be rotated
	 * @return
	 */
	public byte[] rotateText(byte[] text)
	{
		byte[] pt = new byte[4];
		...
		return Arrays.copyOfRange(unpacked, 1, 4);
