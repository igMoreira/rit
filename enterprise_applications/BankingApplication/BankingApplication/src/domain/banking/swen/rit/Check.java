...
public class Check implements Operation {
	...
	public Check(Account originAccount, Double value) {
	...
	public void execute() {
		...
		originAccount.setBalance(originAccount.getBalance() - checkValue);
		for (Fee fee : fees) {
		...
		operationCost = (operationCost - originAccount.getBalance() - checkValue);
