...
public class GenerateTransactionsList implements Command {
	...
	public boolean execute() {
		 ...
		 List<Transaction> transactions = transactionDAO.getByAccountAndDate(accountNumber , new java.sql.Date(dateFrom.getTime()) , new java.sql.Date(dateTo.getTime()));
